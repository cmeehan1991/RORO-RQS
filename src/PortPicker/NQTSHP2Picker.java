 ...
 * @author cmeehan
 */
public class NQTSHP2Picker extends javax.swing.JFrame {
    ...
    private void addRemovePorts(int col) {
        ...
        if (rowSelected) {
            if (col == 0) {
                ...
                MainMenu.tshp2TextField.setText(s);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NQTSHP2Picker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NQTSHP2Picker().setVisible(true);
            }
        });
    }
