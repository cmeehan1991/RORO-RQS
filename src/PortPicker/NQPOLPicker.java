 ...
 * @author cmeehan
 */
public class NQPOLPicker extends javax.swing.JFrame {
    ...
    private void addRemovePorts(int col) {
        ...
        if (rowSelected) {
            if (col == 0) {
                ...
                MainMenu.polTextField.setText(s);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NQPOLPicker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NQPOLPicker().setVisible(true);
            }
        });
    }
